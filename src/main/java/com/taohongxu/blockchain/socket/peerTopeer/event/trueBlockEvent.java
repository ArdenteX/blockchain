...
public class trueBlockEvent extends ApplicationEvent {
    private static final long serialVersionUID = 8945655861906994062L;
     ...
     */
    public trueBlockEvent(ChannelPacket packet) {
        super(packet);
    }
